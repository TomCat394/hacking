...
def loginSC():
	...
	if username =="indonesia" and password =="raya":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/MR.VAN01')
				menu()
